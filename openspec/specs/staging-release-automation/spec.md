# staging-release-automation Specification

## Purpose
Define the repeatable staging release workflow for publishing MemoTree images, handing release metadata to the server, deploying business services, and inspecting logs without mixing release tags with long-lived staging secrets.
